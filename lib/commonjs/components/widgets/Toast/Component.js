...
class ToastComponent extends _react.default.PureComponent {
  constructor() {
    super(...arguments);
  ...
  process() {
    ...
    this.setState({
      ...
      component: typeof component === 'string' ? /*#__PURE__*/_react.default.createElement(_.Text, {
        theme: theme,
      ...
      _reactNative.Animated.timing(animation, {
        easing: _reactNative.Easing.bezier(0.04, 0.9, 0.11, 0.9),
  ...
  render() {
    ...
    }, props), /*#__PURE__*/_react.default.createElement(_reactNativeSafeAreaContext.SafeAreaView, {
      edges: ['top']
    }, component));
  }
