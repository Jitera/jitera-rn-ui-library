...
exports.default = exports.CommonLoadingComponent = void 0;

var _react = _interopRequireDefault(require("react"));

var _reactNative = require("react-native");

var _ThemedComponent = _interopRequireDefault(require("../../atoms/Text/ThemedComponent"));
...
class CommonLoadingComponent extends _react.default.Component {
  constructor() {
    super(...arguments);
  ...
  renderBackground() {
    ...
    return isShow ? /*#__PURE__*/_react.default.createElement(_reactNative.View, _extends({
  ...
  render() {
    ...
    }, this.renderBackground(), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: styles.loading_bar_container
    }, showLoadingIcon ? /*#__PURE__*/_react.default.createElement(_reactNative.Animated.View, {
      style: [styles.image, animationIconOnly ? this.getAnimationStyle() : {}]
    }, /*#__PURE__*/_react.default.createElement(_reactNative.ActivityIndicator, {
      color: loadingColor,
      style: styles.image,
      size: loadingSize
    })) : null, title ? /*#__PURE__*/_react.default.createElement(_ThemedComponent.default, {
      theme: theme,
...
exports.CommonLoadingComponent = CommonLoadingComponent;
